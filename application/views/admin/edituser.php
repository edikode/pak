    ...
    <div class="row mb-5">
        <div class="col-md-8">
            <form method="post" action="">
                ...
                <a href="<?= base_url('pendaftar/user') ?>" class="btn btn-secondary">Kembali</a>
            </form>
        </div>
        <div class="col-md-4">
            <?php $user = $this->db->get_Where('user',['pendaftar_id' => $pendaftar->id])->row(); ?>
            <img src="<?= base_url('assets/img/'.$user->gambar); ?>" class="card-img" alt="<?= $pendaftar->nama; ?>">

            <form action="<?= base_url('pendaftar/user/simpanfoto') ?>" method="post" enctype="multipart/form-data">
                <div class="form-group">
