                ...
                <div class="card-body">
                    <form method="post" action="">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="kode" placeholder="Kode" name="kode" autocomplete="off" value="<?= set_value('kode'); ?>">
                            <?= form_error('kode','<small class="text-danger">','</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="kegiatan">Kegiatan</label>
                            <textarea name="kegiatan" id="kegiatan" class="form-control" autocomplete="off"><?= set_value('kegiatan'); ?></textarea>
                            <?= form_error('kegiatan','<small class="text-danger">','</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="satuan">Satuan</label>
                            <input type="text" class="form-control" id="satuan" placeholder="Satuan" name="satuan" autocomplete="off" value="<?= set_value('satuan'); ?>">
                            <?= form_error('satuan','<small class="text-danger">','</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="angka_kredit">Angka Kredit</label>
                            <input type="text" class="form-control" id="angka_kredit" placeholder="Angka Kredit" name="angka_kredit" autocomplete="off" value="<?= set_value('angka_kredit'); ?>">
                            <?= form_error('angka_kredit','<small class="text-danger">','</small>'); ?>
                        </div>
                        <div class="form-group">
                            <label for="pelaksana">Pelaksana</label>
                            <input type="text" class="form-control" id="pelaksana" placeholder="Pelaksana" name="pelaksana" autocomplete="off" value="<?= set_value('pelaksana'); ?>">
